...
?>
    <div class="gr">
           ...
           <button type="button" class="btn btn-light" data-toggle="modal" data-target="#section1">SECTION I: PHYSICIAN RESPONSIBILITIES RELATED TO PATIENT CARE</button><br><br>
            <button type="button" class="btn btn-light" data-toggle="modal" data-target="#section2">SECTION II: PHYSICIAN RESPONSIBILITIES RELATED TO MEDICAL RECORD DOCUMENTATION AND CONTENT</button><br><br>
            <button type="button" class="btn btn-light" data-toggle="modal" data-target="#section3">SECTION III: PHYSICIAN RESPONSIBILITIES RELATED TO HOSPITAL POLICY AND PROCEDURE</button><br><br>
            <button type="button" class="btn btn-light" data-toggle="modal" data-target="#section4">SECTION IV: ALLIED HEALTH PROFESSIONALS</button><br><br>
            <button type="button" class="btn btn-light" data-toggle="modal" data-target="#section5">SECTION V: SUPERVISION OF GRADUATE STAFF</button><br><br>
            <button type="button" class="btn btn-light" data-toggle="modal" data-target="#section6">Section VI: CORRECTIVE ACTION PROCEDURES FOR MEDICAL STAFF</button><br><br>
